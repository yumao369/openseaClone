...
const getContractInterface = () => {
  ...
  return NFTMarketplaceContractInterface
}

export const NFTMarketplaceProvider = ({ children }) => {
  const NFTMarketplaceContract = getEhereumContract()
  const NFTMarketplaceContractInterface = getContractInterface()
  ...
  return (
    <NFTMarketplaceContext.Provider value={{ connectWallet, currentAccount, NFTMarketplaceContract, NFTMarketplaceABI, NFTMarketplaceContractInterface }}>
      {children}
